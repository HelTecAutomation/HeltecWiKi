...
:::note
- WiFi LoRa 32 Expansion Kit (Glass Panel)

  Supports direct flashing of Meshtastic V4 firmware via the official Web Flasher.

- WiFi LoRa 32 Expansion Kit (Touchscreen)

  Does not support Web flashing. Firmware must be flashed using a local tool.
  For more details, please refer to [this document](/docs/devices/open-source-hardware/esp32-series/lora-32/wifi-lora-32-expansion-kit/usage-guide#flash-via-esp32-flasher-tool).
:::
