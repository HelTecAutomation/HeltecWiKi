...
In the HT-M7603 gateway, the server address, port, switch region,gateway mode need to be configured in the "HT-M7603 Config" interface, please refer to the [HT-M7603](/docs/devices/lorawan-application/lora-gateway/ht-m7603/Usage) document.
