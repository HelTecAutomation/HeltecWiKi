...
Configuring the gateway, please refer to the [HT-M00S](/docs/devices/lorawan-application/lora-gateway/ht-m00s/quick_start) document.
...
Configure M00S, note that the parameters match the registration information on the server, please refer to the [HT-M00S](/docs/devices/lorawan-application/lora-gateway/ht-m00s/quick_start) document.
...
:::tip
If the device does not have a QR code, click 'Input' for manual registration. For product information you can refer to the corresponding 'Quick Start'.
:::
