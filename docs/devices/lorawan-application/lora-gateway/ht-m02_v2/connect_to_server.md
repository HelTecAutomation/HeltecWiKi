...
Configure your gateway and fill in the server address as the server you want to connect to, please refer to the [HT-M2802 Quick Start](/docs/devices/lorawan-application/lora-gateway/ht-m02_v2/quick_start) document.
